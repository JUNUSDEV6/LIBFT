SRCS 	=	ft_bzero.c ft_calloc.c ft_isalnum.c ft_isalpha.c \
			...
			ft_strchr.c ft_tolower.c ft_toupper.c ft_putchar_fd.c\
			ft_strrchr.c ft_atoi.c ft_substr.c ft_putstr_fd.c\
			ft_putendl_fd.c ft_putnbr_fd.c ft_strjoin.c\
			ft_strtrim.c ft_strmapi.c ft_striteri.c ft_itoa.c\
			ft_split.c
SCRCSB	=	ft_lstnew_bonus.c ft_lstadd_front_bonus.c\
